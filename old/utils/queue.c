...
create_undoer_type(uint8_t);
create_undoer_type(int8_t);
create_undoer_type(uint16_t);
create_undoer_type(uint32_t);
create_undoer_type(uint64_t);
create_undoer_type(uintmax_t);
create_undoer_type(uintptr_t);
create_undoer_type(double);
create_undoer_type(float);

create_pundoer_type(uint8_t);
create_pundoer_type(int8_t);
create_pundoer_type(uint16_t);
create_pundoer_type(uint32_t);
create_pundoer_type(uint64_t);
create_pundoer_type(uintmax_t);
create_pundoer_type(uintptr_t);
create_pundoer_type(double);
create_pundoer_type(float);
