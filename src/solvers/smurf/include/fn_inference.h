...
// Inference State Initialization and Deletion
void initInferenceStateType();
void FreeInferenceStateEntry(SmurfManager *SM, TypeStateEntry *pTypeState);

// Inference State Building and Garbage collection
TypeStateEntry *CreateInferenceState(SmurfManager *SM, DdNode *pInfBDD);
...
// Inference State Heuristic Scoring and Garbage Collection
