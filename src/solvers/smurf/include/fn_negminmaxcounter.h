...
#ifndef FN_NEGMINMAXCOUNTER_S_H
#define FN_NEGMINMAXCOUNTER_S_H

// NEGMINMAXCOUNTER State Initialization and Deletion
void initNEGMINMAXCOUNTERStateType();
void FreeNEGMINMAXCOUNTERStateEntry(SmurfManager *SM, TypeStateEntry *pTypeState);

// NEGMINMAXCOUNTER State Building and Garbage collection
...
// NEGMINMAXCOUNTER State Traversing
...
// NEGMINMAXCOUNTER State Printing
...
// NEGMINMAXCOUNTER State Heuristic Scoring and Garbage Collection
...
void LSGBNEGMINMAXCOUNTERStateFree();
extern double ***arrNEGMINMAXWghts;
