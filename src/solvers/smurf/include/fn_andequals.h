...
#ifndef FN_ANDEQUALS_S_H
#define FN_ANDEQUALS_S_H

// ANDEQUALS State Initialization and Deletion
void initANDEQUALSStateType();
void FreeANDEQUALSStateEntry(SmurfManager *SM, TypeStateEntry *pTypeState);

// ANDEQUALS State Building and Garbage collection
...
// ANDEQUALS State Heuristic Scoring and Garbage Collection
double LSGBANDEQUALSStateGetHeurScore(SmurfManager *SM, TypeStateEntry *pTypeState);
double LSGBANDEQUALSStateGetVarHeurScore(SmurfManager *SM, TypeStateEntry *pTypeState, uintmax_t nVbleIndex, uint8_t bPolarity);
void LSGBANDEQUALSStateFree();
